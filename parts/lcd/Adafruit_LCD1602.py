...
class AdafruitCharlcd(object):
    ...
    def __init__(self, pin_rs=25, pin_e=24, pins_db=None, GPIO=None):
    ...
    def pulse_enable(self):
        ...
        self.delay_microseconds(self, 1)  # 1 microsecond pause - enable pulse must be > 450ns
        self.GPIO.output(self.pin_e, True)
        self.delay_microseconds(self, 1)  # 1 microsecond pause - enable pulse must be > 450ns
        self.GPIO.output(self.pin_e, False)
        self.delay_microseconds(self, 1)  # commands need > 37us to settle
